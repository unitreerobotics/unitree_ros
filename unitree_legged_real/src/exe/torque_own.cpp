...
int mainHelper(int argc, char *argv[], TLCM &roslcm)
{
    ...
    rosbag::Bag bag;
    bag.open("/home/bmtsz/test_out/torque_joint_real.bag", rosbag::bagmode::Write);
    ...
    while (ros::ok()){
        ...
        joint_tau.data = RecvLowROS.motorState[FL_1].tauEst;
        bag.write("/FL_thigh_controller/state", elapsed_time, joint_tau);
