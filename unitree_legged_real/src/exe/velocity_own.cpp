...
int mainHelper(int argc, char *argv[], TLCM &roslcm)
{
    ...
    rosbag::Bag bag;
    bag.open("/home/bmtsz/test_out/velocity_joint_real.bag", rosbag::bagmode::Write);
    ...
    while (ros::ok()){
        ...
        joint_vel.data = RecvLowROS.motorState[FL_2].dq;
        bag.write("/FL_calf_controller/state", elapsed_time, joint_vel); 
