...
int mainHelper(int argc, char *argv[], TLCM &roslcm)
{
    ...
    rosbag::Bag bag;
    bag.open("/home/bmtsz/test_out/position_joint_real.bag", rosbag::bagmode::Write);
    ...
    while (ros::ok()){
        ...
        joint_pos.data = RecvLowROS.motorState[FR_2].q;   
        // bag.write("/FR_calf_controller/state", elapsed_time, joint_pos);
